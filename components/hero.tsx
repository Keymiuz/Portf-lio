...
const heroCopy = {
  ...
  en: {
    ...
    description:
      'Professional focused on software development, modern interfaces and digital solutions built with technical clarity, strong user experience and product awareness.',
  ...
  return (
    <section className="relative overflow-hidden rounded-3xl border border-zinc-800/80 bg-zinc-950/70 p-6 shadow-2xl shadow-black/40 backdrop-blur-xl md:p-10">
      ...
      <div className="relative flex flex-col gap-6">
        ...
        <p className="max-w-2xl text-xl text-zinc-200 md:text-2xl">{copy.role}</p>
        <p className="max-w-3xl text-zinc-400">{copy.description}</p>
